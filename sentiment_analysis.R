...
ggsave(filename = paste0(target_dir_plots, "Presentation_sentiment_analysis.png"),
...
# binary tests
# click vs slider: NS
wilcox.test(comm$sentiment[comm$treatment == "Click-and-drag"],
            comm$sentiment[comm$treatment == "Slider"]) %>% tidy()

# click vs text: NS
wilcox.test(comm$sentiment[comm$treatment == "Click-and-drag"],
            comm$sentiment[comm$treatment == "Text"]) %>% tidy()

# click vs distro: NS
wilcox.test(comm$sentiment[comm$treatment == "Click-and-drag"],
            comm$sentiment[comm$treatment == "Distribution"]) %>% tidy()

# slider vs Text: sign
wilcox.test(comm$sentiment[comm$treatment == "Slider"],
            comm$sentiment[comm$treatment == "Text"]) %>% tidy()
...
wilcox.test(comm$sentiment[comm$treatment == "Text"],
            comm$sentiment[comm$treatment == "Distribution"]) %>% tidy()
