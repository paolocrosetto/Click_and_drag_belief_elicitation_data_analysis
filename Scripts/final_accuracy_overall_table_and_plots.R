...
plot_overalls <- overalls %>%
  ...
  mutate(manipulation = case_when(
    type == "Overall" ~ "Overall performance",
...
ggsave(
  filename = paste0(target_dir_plots, "Presentation_accuracy_overall.png"),
...
plot_overalls %>%
  ...
  plot_theme
ggsave(
  filename = paste0(target_dir_plots, "Presentation_accuracy_bytime.png"),
  width = 16 / 1.7, height = 9 / 1.7,
  dpi = 300, units = "in"
)
...
plot_overalls %>%
  ...
  plot_theme
ggsave(
  filename = paste0(target_dir_plots, "Presentation_accuracy_bybins.png"),
  width = 16 / 1.7, height = 9 / 1.7,
  dpi = 300, units = "in"
)
...
plot_overalls %>%
  ...
  plot_theme
ggsave(
  filename = paste0(target_dir_plots, "Presentation_accuracy_byshape.png"),
  width = 16 / 1.7, height = 9 / 1.7,
  dpi = 300, units = "in"
)
